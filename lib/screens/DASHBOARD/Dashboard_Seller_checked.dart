...
class Dashboard_Seller_checked extends StatefulWidget {
  static String id = 'Dashboard_Seller_checked';
  @override
  _Dashboard_Seller_checkedState createState() =>
      _Dashboard_Seller_checkedState();
}

// ignore: camel_case_types
class _Dashboard_Seller_checkedState extends State<Dashboard_Seller_checked> {
  @override
