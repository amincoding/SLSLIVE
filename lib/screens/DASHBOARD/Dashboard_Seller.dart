...
class Dashboard_Seller extends StatefulWidget {
  static String id = 'Dashboard_Seller';
  @override
  _Dashboard_SellerState createState() => _Dashboard_SellerState();
}

// ignore: camel_case_types
class _Dashboard_SellerState extends State<Dashboard_Seller> {
  @override
