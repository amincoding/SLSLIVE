...
class Dashboard_Admin_checked extends StatefulWidget {
  static String id = 'Dashboard_Admin_checked';

  @override
  _Dashboard_Admin_checkedState createState() =>
      _Dashboard_Admin_checkedState();
}

// ignore: camel_case_types
class _Dashboard_Admin_checkedState extends State<Dashboard_Admin_checked> {
  @override
