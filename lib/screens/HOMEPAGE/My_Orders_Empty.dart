...
class My_Orders_Empty extends StatefulWidget {
  static String id = 'My_Orders_Empty';

  @override
  _My_Orders_EmptyState createState() => _My_Orders_EmptyState();
}

// ignore: camel_case_types
class _My_Orders_EmptyState extends State<My_Orders_Empty> {
  @override
